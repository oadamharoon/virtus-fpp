...
class HelloWorldExtension(BaseSampleExtension):
    def on_startup(self, ext_id: str):
        ...
        super().start_extension(
            menu_name="",
            submenu_name="",
            name="Robot test development",
            title="Test",
            doc_link="https://docs.omniverse.nvidia.com/isaacsim/latest/core_api_tutorials/tutorial_core_hello_world.html",
            overview="This extension acts as a mobile robot 3D scanning system test development area through NVIDIA Isaac Sim's asynchronous scripting mode.",
